"""Stop a running application in a Cloudera AI project."""
...
def stop_application(config: Dict[str, str], params: Dict[str, Any] = None) -> Dict[str, Any]:
    """
    Stop a running application in a Cloudera AI project.
    ...
    Args:
        ...
        params: Parameters for the API call:
            ...
            - application_id: ID of the application to stop (required)
    ...
    try:
        ...
        result = client.stop_application(project_id, application_id)
        return {
            "success": True,
        ...
        return {"success": False, "message": f"Error stopping application: {str(e)}", "data": None}
