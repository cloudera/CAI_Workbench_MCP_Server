"""Restart a model deployment in Cloudera AI."""
...
def restart_model_deployment(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        result = client.restart_model_deployment({}, project_id, model_id, build_id, deployment_id)
        return {"success": True, "message": f"Successfully restarted deployment '{deployment_id}'", "data": serialize_result(result)}
