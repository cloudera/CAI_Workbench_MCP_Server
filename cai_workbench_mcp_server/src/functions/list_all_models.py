"""List all models that belong to a user across all projects. function for Cloudera AI Workbench MCP"""

import requests
import json
from typing import Dict, Any

def list_all_models(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        return {
            "success": True,
            "message": "Successfully executed list_all_models",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing list_all_models: {str(e)}"
        }
