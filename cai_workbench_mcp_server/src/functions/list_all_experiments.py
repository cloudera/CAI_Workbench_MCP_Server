"""Lists all experiments that belong to a user across all projects. function for Cloudera AI Workbench MCP"""
...
def list_all_experiments(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        api_url = f"{host}/api/v2/experiments"
        ...
        return {
            "success": True,
            "message": "Successfully executed list_all_experiments",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing list_all_experiments: {str(e)}"
        }
