"""Unregister a model version. function for Cloudera AI Workbench MCP"""
...
def delete_registered_model_version(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Returns:
        delete_registered_model_version results
    """
    try:
        # Validate required parameters
        required_params = ['model_id', 'version_id']
        ...
        api_url = f"{host}/api/v2/registry/models/{params['model_id']}/versions/{params['version_id']}"
        ...
        return {
            "success": True,
            "message": "Successfully executed delete_registered_model_version",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing delete_registered_model_version: {str(e)}"
        }
