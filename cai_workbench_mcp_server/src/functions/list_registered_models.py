"""List registered models. function for Cloudera AI Workbench MCP"""
...
def list_registered_models(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Returns:
        list_registered_models results
    """
    try:
        ...
        return {
            "success": True,
            "message": "Successfully executed list_registered_models",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing list_registered_models: {str(e)}"
        }
