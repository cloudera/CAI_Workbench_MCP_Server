...
def get_model(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        result = client.get_model(project_id, model_id)
        return {"success": True, "message": "Successfully retrieved model", "data": serialize_result(result)}
