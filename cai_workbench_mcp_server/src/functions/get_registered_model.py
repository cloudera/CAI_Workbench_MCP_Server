"""Get a registered model. function for Cloudera AI Workbench MCP"""

import requests
import json
from typing import Dict, Any

def get_registered_model(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        return {
            "success": True,
            "message": "Successfully executed get_registered_model",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing get_registered_model: {str(e)}"
        }
