"""Update a model. function for Cloudera AI Workbench MCP"""

import requests
import json
from typing import Dict, Any

def update_model(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    """
    Update a model.
    ...
    try:
        ...
        required_params = ['project_id', 'model_id']
        ...
        api_url = f"{host}/api/v2/projects/{params['project_id']}/models/{params['model_id']}"
        ...
        return {
            "success": True,
            "message": "Successfully executed update_model",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing update_model: {str(e)}"
        }
