"""Delete a project. function for Cloudera AI Workbench MCP"""
...
def delete_project(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        api_url = f"{host}/api/v2/projects/{params['project_id']}"
        ...
        return {
            "success": True,
            "message": "Successfully executed delete_project",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing delete_project: {str(e)}"
        }
