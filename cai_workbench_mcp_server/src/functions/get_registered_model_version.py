"""Get a registered model version. function for Cloudera AI Workbench MCP"""
...
def get_registered_model_version(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Returns:
        get_registered_model_version results
    """
    try:
        ...
        return {
            "success": True,
            "message": "Successfully executed get_registered_model_version",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing get_registered_model_version: {str(e)}"
        }
