"""Return all the project names the user has access to. function for Cloudera AI Workbench MCP"""
...
def list_project_names(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    """
    Return all the project names the user has access to.
    ...
    try:
        ...
        api_url = f"{host}/api/v2/projectnames"
        ...
        return {
            "success": True,
            "message": "Successfully executed list_project_names",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing list_project_names: {str(e)}"
        }
