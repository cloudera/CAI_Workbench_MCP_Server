"""Delete a model build. function for Cloudera AI Workbench MCP"""
...
def delete_model_build(config: Dict[str, str], params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Returns:
        delete_model_build results
    """
    try:
        # Validate required parameters
        required_params = ['project_id', 'model_id', 'build_id']
        ...
        api_url = f"{host}/api/v2/projects/{params['project_id']}/models/{params['model_id']}/builds/{params['build_id']}"
        ...
        return {
            "success": True,
            "message": "Successfully executed delete_model_build",
            "data": data
        }
        ...
        return {
            "success": False,
            "message": f"Error executing delete_model_build: {str(e)}"
        }
